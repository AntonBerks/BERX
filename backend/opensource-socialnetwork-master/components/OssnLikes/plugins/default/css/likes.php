...
.ossn-like-reactions-panel {
	...
	top: auto;
	margin-top: -75px;
	box-shadow: var(--berx-shadow, 0 1px 5px rgba(0,0,0,0.35));
	border-radius: 2em;
	cursor: default;
	z-index:1000;
}
...
.ossn-reactions-list-wholiked-item img {
	/* Renders inside .ossn-message-box, which BERX already darkened —
	   only the light ring/divider needed to follow it. */
	border: 1px solid var(--berx-border-soft, rgba(255,255,255,0.08));
	border-radius: 100%;
}
