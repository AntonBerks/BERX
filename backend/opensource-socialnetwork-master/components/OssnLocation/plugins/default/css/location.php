...
/* ============================================================
   BERX — dark location autocomplete.
   Real defect: the whole Google-Places-style suggestion list above
   was still that vendor's light theme verbatim (#fff panel, #dadce0
   border, #202124 text) — the entire file had zero BERX coverage,
   even though this dropdown is live (wired in ossn_location.php) and
   appears every time someone tags a location on a post. Overrides
   only; the JS append/toggle logic and .ossn-location-item markup
   are untouched.
   ============================================================ */
.ossn-location-container .ossn-location-icon {
