...
/* ============================================================
   BERX — dark swatch picker panel only.
   #ossn-wall-postbg is the chrome wrapping the colour swatches (a
   plain white panel + light border) — real UI, fixed here.
   .postbg-container's #333 text colour is deliberately NOT touched:
   that is the text typed while composing a background post, shown
   against whatever colour swatch the user picked. Recolouring it
   blind could make text unreadable against a light swatch — a
   content/business-logic choice, not a leftover light-mode surface.
   ============================================================ */
#ossn-wall-postbg {
