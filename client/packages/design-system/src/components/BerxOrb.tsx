...
export interface BerxOrbProps {
	size?: number;
	/** The light wrapping the object — normally the scene's key. */
	light?: string;
	/** Secondary bounce from the opposite side. */
	fill?: string;
			...
			<Svg width={size} height={size} viewBox="0 0 200 200">
				<Defs>
					...
					<RadialGradient id={`${uid}-body`} cx="32%" cy="70%" r="78%">
						...
						<Stop offset="26%" stopColor={light} stopOpacity={0.2} />
					...
					<LinearGradient id={`${uid}-rim`} x1="0.1" y1="0.95" x2="0.85" y2="0.1">
						...
						<Stop offset="30%" stopColor={light} stopOpacity={0.35} />
					...
					<RadialGradient id={`${uid}-core`} cx="50%" cy="50%" r="50%">
						...
						<Stop offset="40%" stopColor={light} stopOpacity={0.28} />
					...
					<LinearGradient id={`${uid}-ring`} x1="0" y1="0" x2="1" y2="0">
						...
						<Stop offset="45%" stopColor={light} stopOpacity={0.28} />
						<Stop offset="100%" stopColor={fill} stopOpacity={0.55} />
					</LinearGradient>
					{/* The halo the glass throws into the air around it. */}
					<RadialGradient id={`${uid}-halo`} cx="50%" cy="50%" r="50%">
						<Stop offset="52%" stopColor={light} stopOpacity={0} />
						<Stop offset="62%" stopColor={light} stopOpacity={0.16} />
						<Stop offset="78%" stopColor={light} stopOpacity={0.06} />
						<Stop offset="100%" stopColor={light} stopOpacity={0} />
					</RadialGradient>
				</Defs>
