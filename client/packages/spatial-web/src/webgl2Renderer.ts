...
/** Concrete adapter for the shared renderer contract. */
export class BerxWebGL2Renderer implements BerxSpatialRenderer {
  readonly kind='webgl2' as const;
  readonly capabilities={perspective:true,depthBuffer:true,physicallyLitMaterials:false,shadows:false,postProcessing:false};
