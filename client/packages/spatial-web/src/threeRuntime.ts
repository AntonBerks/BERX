...
export class BerxThreeRuntimeRenderer implements BerxSpatialRenderer {
  ...
  */
 dispose(){const gl=this.gl;this.releaseMeshes();this.textures.dispose();this.media.clear();gl.deleteProgram(this.program);gl.getExtension('WEBGL_lose_context')?.loseContext();}
  ...
  */
 handleContextLost(){this.meshes.clear();this.textures.handleContextLost();}
}
